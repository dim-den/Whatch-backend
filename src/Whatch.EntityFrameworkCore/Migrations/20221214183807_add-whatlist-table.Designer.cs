...
{
    [DbContext(typeof(WhatchDbContext))]
    [Migration("20221214183807_add-whatlist-table")]
    partial class addwhatlisttable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Whatch.Models.Actor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Whatch.Models.Film", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Whatch.Models.FilmCast", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Whatch.Models.FilmReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FilmReviews", (string)null);
                });

            modelBuilder.Entity("Whatch.Models.Watchlist", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Whatchlists", (string)null);
                });
            ...
            modelBuilder.Entity("Whatch.Models.FilmCast", b =>
                {
                    b.HasOne("Whatch.Models.Actor", "Actor")
                        .WithMany("Casts")
                        .HasForeignKey("ActorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Whatch.Models.Film", "Film")
                        .WithMany("Casts")
